...
export const api = {
  ...
  ontology: {
    ...
    // [CONSTITUTIONAL UI] Register Schema Mapping
    registerSchema: async (entityType: string, fields: any[]) => {
      const res = await client.post('/ontology/schema/register', {
    ...
    // [CONSTITUTIONAL UI] Lock the system (Phase 1 -> Phase 2)
    lockSystem: async () => {
